...
/**
 * Test case for class Tx_PxaNewsletterSubscription_Domain_Model_NewsLetterSubscription.
 *
 * @version $Id$
 ...
 */
class Tx_PxaNewsletterSubscription_Domain_Model_NewsLetterSubscriptionTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
